...
/**
 * Express middleware for XRayWell
 * usage: app.use(expressXRayMiddleware({ name: "my-application" }));
 * @param middlewareConfig Setup baheavor of segments generated by express
 */
